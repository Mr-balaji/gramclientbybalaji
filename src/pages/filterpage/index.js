...
export default function AddUser() {
  ...
  console.log("selectedothervillagecome", selectedothervillagecome);
  ...
  const onSubmit = async(data) => {
    ...
    localStorage.setItem('filterdData', JSON.stringify(data));
              ...
              <div className="custom_tab mt-5">
                ...
                >
                  ...
                  /> */}
                          ...
                          <div className="col-span-4 ">
                            <label className="block label-text">
                              <span className="block mb-1">शाळेचे Address--</span>
                              {/* <Controller
                    render={({ field }) => (
                      <InputText placeholder="" {...field} className="w-full" />
                    )}
                  ...
                  /> */}
                          ...
                          <div className="col-span-4 ">
                            <label className="block label-text">
                              <span className="block mb-1">Collage Address--</span>
                              {/* <Controller
                    render={({ field }) => (
                      <InputText placeholder="" {...field} className="w-full" />
                    )}
                    ...
                    <div className="grid lg:grid-cols-12 xl:gap-[0.250vw] gap-5 divide-x-2">
                      <div className="col-span-12">
                        <div className="grid lg:grid-cols-12 xl:gap-[1.250vw] gap-5">
                          ...
                          <div className="col-span-4 ">
                            <label className="block label-text">
                              <span className="block mb-1">घराचा प्रकार sq</span>
                              <Controller
                                render={({ field }) => (
                                  <InputText
                                    placeholder=""
                              ...
                              <Controller
                                render={({ field }) => (
                                  <AutoComplete
                                    field="name"
                                    multiple
                                    value={selectedJanavar}
                                    suggestions={filteredCountries}
                                    completeMethod={(e) => {
                                      search(e, selectedJanavarList),
                                        handleCreate(
                                          e,
                                          selectedJanavarList,
                                          setSelectedJanavareList,
                                          "Janavare"
                                        );
                                    }}
                                    onChange={(e) => {
                                      setSelectedJanavare(e.value),
                      ...
                      <div className="col-span-12">
                        <div className="grid lg:grid-cols-12 xl:gap-[1.250vw] gap-5">
                          ...
                          {selectdedBankKhate === "हो" ? (
                            <div className="col-span-4 ">
                              <label className="block label-text">
                                <span className="block mb-1">बँक Name </span>
                                <Controller
                                  render={({ field }) => (
                                    <AutoComplete
                                      field="name"
